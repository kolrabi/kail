...
//	png_init_io(png_ptr, PngFile);
	...
	*/
	...
	text[i].key 				= "Generated by";
	text[i].text 				= "Generated by the kolrabi's another Image Library (KaIL)";
	text[i].compression = PNG_TEXT_COMPRESSION_NONE;
	i++;

	text[i].key 				= "Author";
	text[i].text 				= iGetString(IL_PNG_AUTHNAME_STRING);
	text[i].compression = PNG_TEXT_COMPRESSION_NONE;
	if (text[i].text) i++;

	text[i].key 				= "Description";
	text[i].text 				= iGetString(IL_PNG_DESCRIPTION_STRING);
	text[i].compression = PNG_TEXT_COMPRESSION_NONE;
	if (text[i].text) i++;

	text[i].key 				= "Title";
	text[i].text 				= iGetString(IL_PNG_TITLE_STRING);
	text[i].compression = PNG_TEXT_COMPRESSION_NONE;
	if (text[i].text) i++;
