...
static ILconst_string iluErrorStringsSpanish[IL_FILE_READ_ERROR - IL_INVALID_ENUM + 1] = {
...
static ILconst_string iluLibErrorStringsSpanish[IL_LIB_EXR_ERROR - IL_LIB_GIF_ERROR + 1] = {
...
static ILconst_string iluMiscErrorStringsSpanish[2] = {
  IL_TEXT("no error"),
