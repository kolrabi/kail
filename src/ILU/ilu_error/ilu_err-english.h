...
static ILconst_string iluErrorStringsEnglish[IL_FILE_READ_ERROR - IL_INVALID_ENUM + 1] = {
...
static ILconst_string iluLibErrorStringsEnglish[IL_LIB_EXR_ERROR - IL_LIB_GIF_ERROR + 1] = {
...
static ILconst_string iluMiscErrorStringsEnglish[2] = {
  IL_TEXT("no error"),
