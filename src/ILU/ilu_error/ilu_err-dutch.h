...
static ILconst_string iluErrorStringsDutch[IL_FILE_READ_ERROR - IL_INVALID_ENUM + 1] = {
...
static ILconst_string iluLibErrorStringsDutch[IL_LIB_EXR_ERROR - IL_LIB_GIF_ERROR + 1] = {
...
static ILconst_string iluMiscErrorStringsDutch[2] = {
  IL_TEXT("geen fout"),
