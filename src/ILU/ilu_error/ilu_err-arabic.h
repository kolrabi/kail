...
static ILconst_string iluErrorStringsArabic[IL_FILE_READ_ERROR - IL_INVALID_ENUM + 1] = {
...
static ILconst_string iluLibErrorStringsArabic[IL_LIB_EXR_ERROR - IL_LIB_GIF_ERROR + 1] = {
...
static ILconst_string iluMiscErrorStringsArabic[2] = {
  IL_TEXT("لايوجد خطأ"),
